...
public class AddressActivity$$ViewBinder<T extends liuliu.qs.ui.AddressActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558590, "field 'addAddressLl'");
    target.addAddressLl = finder.castView(view, 2131558590, "field 'addAddressLl'");
    view = finder.findRequiredView(source, 2131558532, "field 'mainLv'");
    target.mainLv = finder.castView(view, 2131558532, "field 'mainLv'");
    view = finder.findRequiredView(source, 2131558592, "field 'emptyTv'");
    target.emptyTv = finder.castView(view, 2131558592, "field 'emptyTv'");
    view = finder.findRequiredView(source, 2131558591, "field 'refreshRfl'");
    target.refreshRfl = finder.castView(view, 2131558591, "field 'refreshRfl'");
